...
import 'package:trendy_chikitsa/models/healer_responses/upgrade_plan_response.dart';
...
class PricingDataSecond extends StatefulWidget {
  String tabNumber;
  ...
  @override
  State<PricingDataSecond> createState() => PricingDataSecondState();
}

class PricingDataSecondState extends State<PricingDataSecond> {
  final int _value = 1;
  ...
  Future<void> initializePayment(String amountParam, String productInfo, String transactionID) async {
...
//Implement Your Failed Payment Logic
  ...
  Future<String?> updatePricingPlan(String transID, String amount) async {
    ...
    var request = http.MultipartRequest('POST', BaseuURL.upgrade_plan);
          ...
          http.Response.fromStream(result).then((response) {
            if (response.statusCode == 200) {
              ...
              if (data["status"] == "true" ) {
               ...
               UpgradePlanResponse pricingPlanResponse =
               UpgradePlanResponse.fromJson(jsonDecode(response.body));
                  ...
                  if (Navigator.canPop(context)) {
                    Navigator.pushAndRemoveUntil<dynamic>(
                      ...
                      MaterialPageRoute<dynamic>(
                        builder: (BuildContext context) => const Home_Menu(),
                      ),
                          (route) =>
