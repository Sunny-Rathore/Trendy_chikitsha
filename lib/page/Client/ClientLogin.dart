...
import 'package:trendy_chikitsa/page/Client/Client%20Register/ClientRegister.dart';
import 'package:trendy_chikitsa/page/Healer/Healer%20Register/Healer_Forgotpass.dart';

import '../../global/global.dart';
import '../../models/client_responses/client_login_response.dart';
import '../../models/healer_responses/healer_login_response.dart';
import '../../utils/color_utils.dart';
import '../../utils/string_utils.dart';
import '../../widget/text_widget.dart';
import '../../widgets/spinKitFadingCircleWidget.dart';
import 'Client_menu/pages/Client_Home_Menu.dart';
import 'Client_menu/pages/client_looking_for.dart';
import '../LoginPage.dart';
import '../Healer/Choose Your Expertise/HealerChooseExperties.dart';
import '../Healer/Healer_menu/Menu Pages/Home_Menu.dart';
import '../Healer/Healer_menu/pages/healer_pricing_plan.dart';
                ...
                Align(
                    ...
                    child: Padding(
                        ...
                        child: Column(
                              ...
                              InkWell(
                                ...
                                onTap: () {
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (_) =>
                                         ClientRegisterPage(isLookingFor: false,)));
                          ...
                          Visibility(visible: prefs!=null &&  prefs!.getString(StringUtils.type).toString() == "2",child:     InkWell(
                                child: RichText(
                                    text: TextSpan(
            ...
            if (prefs!.getString(StringUtils.type).toString() == "1") {
              if (data["status"] == "false" &&
                ...
                if (loginUser!.response == "pricing plan") {
                  ...
                  prefs!.setString(StringUtils.subscriptionPlan, loginUser!.healerData!.subscriptionPlan.toString());
                  Future.delayed(const Duration(seconds: 2), () {
                    isLoading = false;
                    setState(() {});
                    Navigator.of(context).push(MaterialPageRoute(
            ...
            prefs!.setString(StringUtils.loginINAPP, "YES");*/
              ...
              if (data["status"] == "true" &&
                ...
                prefs!.setString(StringUtils.name,
                    loginUser.clientData!.clName.toString());
