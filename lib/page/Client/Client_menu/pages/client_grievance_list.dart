...
import 'package:trendy_chikitsa/models/client_responses/add_complain_response.dart';

import 'package:trendy_chikitsa/models/client_responses/client_appointment_response.dart';
import 'package:trendy_chikitsa/models/client_responses/complain_list_response.dart';
...
class ClientGrievanceList extends StatefulWidget {
  String from_page = "", token = "";

  ClientGrievanceList({super.key});

  @override
  ClientGrievanceListState createState() =>ClientGrievanceListState();
...
class ClientGrievanceListState extends State<ClientGrievanceList>
...
/*  @override
    ...
    return Sizer(builder: (context, orientation, deviceType) {
      return Scaffold(
       ...
       /*   drawer: NavDrawer(),*/
          ...
          body: FutureBuilder<ComplainListResponse?>(
                                                          ...
                                                          Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                SizedBox(
                                                                  width: 40.w,
                                                                  child: Text(
                                                                      _healerTransactionHistoryResponse!.response![index].ticketId.toString(),
                                                                      textAlign: TextAlign.left,
                                                                      maxLines: 2,
                                                                      style: TextStyle(
                                                                          fontWeight: FontWeight.normal,
                                                          ...
                                                          MainAxisAlignment.end,
                                                              ...
                                                              children: [  Text("Status",
                                                                ...
                                                                SizedBox(
                                                                  width: 40.w,
                                                                  child: Text(
                                                                      _healerTransactionHistoryResponse!.response![index].status.toString(),
                                                          ...
                                                          Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              SizedBox(
                                                                  width: 45.w,
                                                                  child: Text(
                                                                      _healerTransactionHistoryResponse!.response![index].comment.toString(),
                                                                      textAlign: TextAlign.left,
                                                                      style: TextStyle(
                                                                          fontWeight: FontWeight.normal,
                                                                          color: ColorUtils.blackColor,
                                                          ...
                                                          Column(
                                                            ...
                                                            children: [ Text("Date",
                                                              ...
                                                              SizedBox(
                                                                  width: 40.w,
                                                                  child: Text(
                                                                      changeStringToDate(_healerTransactionHistoryResponse!.response![index].date.toString()),
                                                                      textAlign: TextAlign.right,
                                                                      style: TextStyle(
                                                                          fontWeight: FontWeight.normal,
                                                                          color: ColorUtils.blackColor,
  ...
  ComplainListResponse? _healerTransactionHistoryResponse;

  Future<ComplainListResponse?> getHealerTransactions() async {
    var data;
    var request =
        http.MultipartRequest('POST', BaseuURL.complain_list);
    ...
    if (response.statusCode == 200) {
      ...
      if (data["status"] == "true" && data["msg"] == "success") {
        ...
        _healerTransactionHistoryResponse =
            ComplainListResponse.fromJson(jsonResponse);
      ...
      builder: (context) {
        ...
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              title: const Text("Share your concern here"),
                            ...
                            child: Padding(
                                ...
                                child: SizedBox(
                                    ...
                                    child: ElevatedButton(
                                        ...
                                        onPressed: () {
                                          submitReview(_textEditingController.text.toString());
                                        }))),
                          ),
                          onTap: () async {
submitReview(_textEditingController.text.toString());
...
AddComplainResponse? _submitReviewResponse;

  Future<String?> submitReview(String comments) async {
    isLoading = true;
    setState(() {});
    var data;
    print(
        'updateScheduleTime      $comments');
    var request = http.MultipartRequest('POST', BaseuURL.add_complain);
    ...
    request
      ...
      http.Response.fromStream(result).then((response) {
        if (response.statusCode == 200) {
          ...
          if (data["status"] == "true" &&
              (data["msg"] == "Success! Your complaint has been submitted successfully.")) {

_submitReviewResponse=    AddComplainResponse.fromJson(jsonDecode(response.body));
