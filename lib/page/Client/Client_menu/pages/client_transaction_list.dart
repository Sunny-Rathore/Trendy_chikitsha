...
import 'package:trendy_chikitsa/models/client_responses/client_transaction_history_response.dart';
...
class ClientTransactionList extends StatefulWidget {
  String from_page = "", token = "";

  ClientTransactionList({super.key});

  @override
  ClientTransactionListState createState() =>ClientTransactionListState();
...
class ClientTransactionListState extends State<ClientTransactionList>
...
/*  @override
    ...
    return Sizer(builder: (context, orientation, deviceType) {
      return Scaffold(
       ...
       /*   drawer: NavDrawer(),*/
          ...
          body: FutureBuilder<ClientTransactionHistoryResponse?>(
                                                        ...
                                                        children: [
                                                          Column(
                                                              ...
                                                              children: [  Text("Paid To",
                                                                ...
                                                                SizedBox(
                                                                  width: 40.w,
                                                                  child: Text(_healerTransactionHistoryResponse!.response![index].paid_to.toString().trim().isEmpty || _healerTransactionHistoryResponse!.response![index].paid_to.toString().trim()=='null'?'':
                                                                      _healerTransactionHistoryResponse!.response![index].paid_to.toString(),
                                                                      textAlign: TextAlign.left,
                                                                      maxLines: 2,
                                                                      style: TextStyle(
                                                                          fontWeight: FontWeight.normal,
  ...
  ClientTransactionHistoryResponse? _healerTransactionHistoryResponse;

  Future<ClientTransactionHistoryResponse?> getHealerTransactions() async {
    var data;
    var request =
    ...
    if (response.statusCode == 200) {
      ...
      if (data["status"] == "true" && data["msg"] == "success") {
        ...
        _healerTransactionHistoryResponse =
            ClientTransactionHistoryResponse.fromJson(jsonResponse);
